function [detectedFeatures,pixelPos] = detectThreshLocMax(image,...
...
%
%OUTPUT 
%       detectedFeatures:various features characterizing detected objects
%           .xCoord = x-coordinates
%           .yCoord = y-coordinates
%           .zCoord = z-coordinates if applicable
%           .amp = first column is mean intensity of object and second
%           column is size
%           .ecc = eccentricity of segmented object
%           .size = size of object
%
%
%       pixelPos : Mask of all objects. 1 inside objects, 0 outside.
%
...
spreadThreshold = prctile(vertcat(s.Spread),1);
